...
class MyTestApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: MyTextHomePage(  title: 'Flutter Demo Home Page'),
    );
  }
}
...
class MyTextHomePage extends StatefulWidget {
  ...
  const MyTextHomePage({Key? key, required this.title}) : super(key: key);
  // MyTextHomePage({  Key key, required this.title}) : super(key: key);
...
class _MyHomePageState extends State<MyTextHomePage> {
  var dimension = 40.0;
